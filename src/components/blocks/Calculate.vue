...
<template>
  <section
    class="relative w-[1440px] h-[990px] bg-white mx-auto"
    aria-label="Calculation of materials supply"
  >
    <!-- Фоновое изображение storage -->
    <img
      class="absolute top-[calc(50.00%_-_495px)] left-[calc(50.00%_-_720px)] w-[1440px] h-[990px] aspect-[1.76] object-cover"
      alt="Storage"
      :src="storageImage"
    />
    ...
    <div
      class="absolute top-[calc(50.00%_-_335px)] left-[calc(50.00%_-_464px)] w-[928px] h-[670px] flex items-center justify-center bg-white rounded-[32px] overflow-y-scroll"
    >
